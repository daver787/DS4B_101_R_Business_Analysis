...
The Data Science Team has developed a pricing model that uses predictive analytics to estimate the price of the two new bicycle models based on the existing fleet. This ensures the new models are priced comparatively to other similar bicycles.

New product prediction for 2 new models:

1. Trigger, Over Mountain with Aluminum Frame: $2,695

2. Slice, Triathalon with Aluminum Frame: $2,057
...
2. New __Aluminum__ line of bikes in the __Triathlon Category__
...
model_07_xgboost %>%
    ...
    gather(key = "New Model Attribute", value = "Value", -model, factor_key = T) %>%       spread(key = model, value = Value) %>%
    knitr::kable()

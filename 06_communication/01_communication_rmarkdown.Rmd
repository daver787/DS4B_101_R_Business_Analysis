...
# results = "hide" (Show code, and run, but don't show output)/ fig.keep(supress figure output)
...
```{r, out.width="100px", echo=FALSE, fig.cap="Business Science Logo",fig.align ="left"}
...
Read in data and print to HTML. Notice effect of `df_print: paged` option for HTML[^1]. 
...
```{r, results ="markup"}
bike_orderlines_tbl <- read_rds(file = "../00_data/bike_sales/data_wrangled/bike_orderlines.rds")

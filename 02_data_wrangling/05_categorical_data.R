...
sales_by_cat2_tbl %>%
    mutate(category_2           = category_2%>%as.character(),
           category_2_as_factor = category_2%>%as_factor()%>%as.numeric(),
           category_2_as.factor =category_2 %>% as.factor()%>% as.numeric())
